...
require_file "docs/response-strategy-autonomy.md"
require_file "docs/codex-hub-orchestration.md"
...
require_file "hooks/scripts/codex_hook_gate.py"
require_file "hooks/scripts/multillm_orchestrator.py"
require_file "hooks/scripts/refinment.py"
require_file "hooks/scripts/runtime_config.py"
require_file "hooks/scripts/response_strategy_bridge.py"
...
require_file "tests/test_codex_hook_gate.py"
require_file "tests/test_response_strategy_bridge.py"
require_file "tests/test_refinment.py"
require_file "tests/test_multillm_orchestrator.py"
...
say "validate: codex-hook-gate unit tests pass"
python3 "$repo_root/tests/test_codex_hook_gate.py"

say "validate: response-strategy bridge unit tests pass"
python3 "$repo_root/tests/test_response_strategy_bridge.py"

say "validate: refinment unit tests pass"
python3 "$repo_root/tests/test_refinment.py"

say "validate: multillm-orchestrator unit tests pass"
python3 "$repo_root/tests/test_multillm_orchestrator.py"
