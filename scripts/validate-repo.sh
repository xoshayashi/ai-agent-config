...
require_file "tests/test_peer_prompt_refinement.py"
...
say "validate: peer-prompt-refinement unit tests pass"
python3 "$repo_root/tests/test_peer_prompt_refinement.py"
