...
def canonical_planning_block(
  ...
  insight_decision:
    ...
    honey_bar_style: [Honey bottom bar uses #F5E2A8 flat pale fill, #C49A2C thin 2-3px outline, optional left icon well, one #C49A2C vertical separator, #2D332E or #8A6400 text, and no dashed border]
...
post_generation_audit:
  ...
  - Honey message boxes use #F5E2A8 fill, #C49A2C thin outline/separator, optional left icon well, and #2D332E or #8A6400 text consistently
