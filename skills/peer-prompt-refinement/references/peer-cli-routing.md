...
- If Gemini still reports workspace trust issues despite `--skip-trust`, treat it as an authentication or higher-level workspace configuration block and continue with the original prompt.
